package com.sjsu.cmpe273.bluetoothexample;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myLabel.setTextColor(Color.parseColor("#000000"));
                                ...
                                if (b == delimiter) {
                                    ...
                                    handler.post(new Runnable() {
                                        public void run() {
                                            ...
                                            if (data.equalsIgnoreCase("light on")) {
                                                myLabel.setTextColor(Color.parseColor("#00ff00"));
                                            } else if (data.equalsIgnoreCase("light off")) {
                                                myLabel.setTextColor(Color.parseColor("#ff0000"));
                                            } else {
                                                myLabel.setTextColor(Color.parseColor("#000000"));
                                            }
                                        }
        ...
        tempButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                (new Thread(new workerThread("nothing"))).start();
